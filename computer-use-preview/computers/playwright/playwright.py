...
class PlaywrightComputer(Computer):
    ...
    def __enter__(self):
        ...
        # Add video recording if directory is specified
        if self._record_video_dir:
            context_options["record_video_dir"] = self._record_video_dir
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        if self._record_video_dir and self._page:
            try:
                self._video_path = self._page.video.path()
            except Exception:
